...
find_materialize_position(std::vector<std::string> attribute, std::unordered_map<std::string, int> &from_pipeline,
	...
	std::ifstream file("/home/yihao/duckdb/ht/duckdb/examples/embedded-c++/release/query/" + query_name +
	                   "_schema.json");
	file >> schema;
	file.close();
...
int main(int argc, char *argv[]) {
	...
	DuckDB db_com("/home/yihao/duckdb/origin/duckdb/examples/embedded-c++/release/micro_test.db");
